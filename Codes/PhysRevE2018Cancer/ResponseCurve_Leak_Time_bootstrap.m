...
DataFull = [0.0098 0.0148 0.0167; 0.0118 0.0203 0.0378; 0.0206 0.0385 0.1033; 0.0379 0.0682 0.193];
...
plot(d,M_kill_72,'k','linewidth',4)
% hold on
...
axis([0 max(DataDose) 0 1.1*max(DataFull(end,:))]);
hold on
ec50_bootstrap([0, 0.1, DataDose],[0; DataFull(:,3)]');
