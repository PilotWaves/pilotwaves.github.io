...
%plot(E_loss_in, E_loss_out1, '--', E_gain_out, E_gain_in, 'linewidth', 4)
%plot(E_loss_in, E_loss_out4, '--', E_gain_out, E_gain_in, 'linewidth', 4)
plot(E_loss_in, E_loss_out20, '--', E_gain_out, E_gain_in, 'linewidth', 4)

%axis([min(E_loss_in) max(E_loss_in) min(E_loss_out1) max(E_loss_out1)/3])
%axis([min(E_loss_in) max(E_loss_in) min(E_loss_out4) max(E_loss_out4)])
axis([min(E_loss_in) max(E_loss_in) min(E_loss_out20) max(E_loss_out4)/2])
